...
3. Zgodnie z ustawą szczepienie można wykonać wtedy gdy jest wykonane badanie kwalifikacyjne. Badanie kwalifikacyjne nie jest obowiązkowe, zatem każdemu przysługuje prawo jego odmowy. Zatem w sytuacji gdy zobowiązany lub jego prawny opiekun odmawia wykonania badania - szczepienie nie może być wykonane.
...
W przypadku otrzymania upomnienia należy złożyć pismo "odmowa badania kwalifikacyjnego" - wzory pism do pobrania tutaj
...
Sanepid niestety nie akceptuje takiej odmowy, argumentując, że szczepienie jest obowiązkowe więc nie można odmówić. Naszym zdaniem jest to pogląd błędny, ale nie ma to na razie potwierdzenia w orzecznictwie.
...
b) Jeżeli z ważnych przyczyn nie mogłeś złożyć odwołania w terminie, możesz złożyć wniosek o przywrócenie terminu. Wynika to z art.58 KPA:
...
Praktyka pokazuje, że punkt b) może być zastosowany tylko w poważnych przypadkach, tak więc zwykle korzystaj z punktu a).
...
W razie pytań, wątpliwości, problemów - pisz na forum w temacie PROŚBY O POMOC lub bezpośrednio do mnie: brickbazooka@interia.pl
